...
import com.vnosc.picArty.libs.flickr.ImageUtils.DownloadedDrawable;;

public class LoadUserTask extends AsyncTask<OAuth, Void, User> {
	/**
	 * 
	 */
	private final FlickShareActivity flickrjAndroidSampleActivity;
	private ImageView userIconImage;
	private final Logger logger = LoggerFactory.getLogger(LoadUserTask.class);
	
	public LoadUserTask(FlickShareActivity flickrjAndroidSampleActivity, 

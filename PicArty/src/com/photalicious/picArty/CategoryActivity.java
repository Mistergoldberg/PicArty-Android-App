		...
		try {
			for (int i = 0; i < Common.NUMBER_OF_MASK; i++) {
				LinearLayout.LayoutParams param = new LinearLayout.LayoutParams(
						(int) (196 * ((float) widthScreen / Common.WIDTH_SCREEN)),
						(int) (196 * ((float) widthScreen / Common.WIDTH_SCREEN)));
				param.setMargins(0, (int) (15 * ((float) heightScreen / Common.HEIGHT_SCREEN)), 0,
						(int) (15 * ((float) heightScreen / Common.HEIGHT_SCREEN)));
